...
public class CourseEnrollment {
    ...
    public static void main(String[] args) {
       //create instance of JDBC helper
        ...
        printStudentList("Students", true, q0, jdbc); 
    ...
    private static void printStudentList(String header, boolean displayId, String query, JdbcHelper jdbc){
    ...
    private static void printStudentsInCourse(String course, JdbcHelper jdbc){
        String q = "SELECT firstName, lastName FROM Student "
                ...
                + "WHERE CourseStudent.courseId = " + "'" + course + "'";
        printStudentList("Students in " + course, false, q, jdbc); 
    }
}
